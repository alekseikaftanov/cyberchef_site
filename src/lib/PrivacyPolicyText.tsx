  ...
  <div className="w-full flex flex-col gap-4 sm:gap-6 lg:gap-8">
    ...
    <div className="flex flex-col gap-4 sm:gap-6 w-full max-w-[884px]">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 w-full">
        <h2 className="font-[var(--font-inter)] font-normal text-lg sm:text-xl leading-[135%] tracking-[-0.02em] text-white w-full">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 w-full">
        ...
        <p className="font-[var(--font-inter)] font-normal text-base sm:text-lg lg:text-xl leading-[135%] tracking-[-0.02em] text-white opacity-80 w-full">
          3.7.2. Для реализации права на дополнение, исправление, блокировку и удаление персональных данных, Субъект персональных данных вправе направить письменное обращение на адрес электронной почты Оператора, указанный в настоящей Политике.
        </p>
        <p className="font-[var(--font-inter)] font-normal text-base sm:text-lg lg:text-xl leading-[135%] tracking-[-0.02em] text-white opacity-80 w-full">
        ...
        <p className="font-[var(--font-inter)] font-normal text-base sm:text-lg lg:text-xl leading-[135%] tracking-[-0.02em] text-white opacity-80 w-full">
          3.7.3.5. В случаях, предусмотренных применимым законодательством, Субъект персональных данных обладает другими правами, не указанными выше.
        </p>
        <p className="font-[var(--font-inter)] font-normal text-base sm:text-lg lg:text-xl leading-[135%] tracking-[-0.02em] text-white opacity-80 w-full">
      ...
      <div className="flex flex-col gap-4 sm:gap-6 w-full">
        ...
        <p className="font-[var(--font-inter)] font-normal text-base sm:text-lg lg:text-xl leading-[135%] tracking-[-0.02em] text-white opacity-80 w-full">
          Общество с ограниченной ответственностью «Кибершеф» ИНН 9734016610, ОГРН 1257700361621 Адрес: 123592, г. Москва, вн.тер.г. муниципальный округ Строгино, ул. Кулакова, д. 20, к. 1, помещ. 8/1. Номер телефона: +7 (495) 134-63-63 Электронная почта: info@cyberchef-vv.ru
        </p>
        <p className="font-[var(--font-inter)] font-normal text-base sm:text-lg lg:text-xl leading-[135%] tracking-[-0.02em] text-white opacity-80 w-full">
