          ...
          <div className="flex flex-col gap-20 w-full lg:w-[884px]">
            ...
            <div className="flex flex-col gap-6 w-full">
              ...
              <p className="text-black/80 font-[var(--font-inter)] font-normal text-lg md:text-xl lg:text-[20px] leading-[135%] tracking-[-0.02em] max-w-[884px]">
                Компания «Кибершеф» учреждена ВкусВилл для развития технологической инфраструктуры в ритейле и цифровой трансформации бизнес-процессов. Свяжитесь с нами, чтобы узнать больше о наших услугах и учтонить стоимость проекта
              </p>
            </div>
